...
> [!NOTE]
> Previous to `v3.0.0-prerelease1`, [Conventional Commits](https://conventionalcommits.org/en/v1.0.0/) were not enforced in the repository, hence the lack of content below this note.
