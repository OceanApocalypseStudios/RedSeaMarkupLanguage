...
> [!NOTE]
> This page is also available in a shorter format [here](https://github.com/OceanApocalypseStudios/RedSeaMarkupLanguage/blob/main/EDITOR.md).
...
**Planned features:**
- Evaluate RSML from within Visual Studio _(current host, default common hosts and custom host)_
- "Lightbulb" actions _(IntelliSense suggestions)_
...
## JetBrains IDEs
Currently unsupported, but official extensions are planned.

## Zed
Currently unsupported, but official extensions are planned.

## Emacs
Currently unsupported. No plans to support in the near future.
