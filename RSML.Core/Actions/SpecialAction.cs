...
namespace RSML.Core.Actions
{
	...
	/// <param name="functionArgument">The string argument passed to this delegate</param>
	...
	public delegate byte SpecialAction(RSParser parser, string functionArgument);
