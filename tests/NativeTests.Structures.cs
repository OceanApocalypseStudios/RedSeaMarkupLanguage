...
namespace OceanApocalypseStudios.RSML.Tests
{
	...
	public partial class NativeTests
	{
		...
		[InlineData(10, 14, 90)]
		[InlineData(3, -1, 825)]
		public void Ext_ToManagedToken_ConvertsCorrectly(
			byte kind,
			int start,
			int end
		)
		{
			...
			var managedToken = new NativeToken
			{
				kind = kind,
				startIndex = start,
				endIndex = end
		...
		public void Ext_ToNativeToken_ConvertsCorrectly(
			TokenKind kind,
			int start,
			int end
		)
