...
public class ReadOnlyStringBufferTests
{
	...
	[DataRow(TestString02, 0, 0)]  // H in "Hey"
	[DataRow(TestString02, 3, 0)]  // CR in "Hey\r\n"
	[DataRow(TestString02, 4, 0)]  // LF in "Hey\r\n"
	[DataRow(TestString02, 5, 1)]  // T in "This"
	[DataRow(TestString02, 6, 1)]  // h in "This"
	[DataRow(TestString02, 13, 3)] // A in "A Test"
	[DataRow(TestString02, 15, 3)] // T in "Test"
	[DataRow(TestString02, 22, 4)] // M in "Method"
	[DataRow(TestString02, 28, 4)] // First CR in "\r\n\r\n."
	[DataRow(TestString02, 29, 4)] // First LF in "\r\n\r\n."
	[DataRow(TestString02, 30, 5)] // Second CR in "\r\n\r\n."
	[DataRow(TestString02, 31, 5)] // Second LF in "\r\n\r\n."
	[DataRow(TestString02, 32, 6)] // Dot/point in "\r\n\r\n."
	[DataRow(TestString02, 33, 7)] // EOF
	public void GetLineNumberForIndex(string data, int index, int expectedLineCount)
	{
		var buffer = new ReadOnlyStringBuffer(data);
		buffer.BuildCache();
		Assert.AreEqual(expectedLineCount, buffer.GetLineNumberFromIndex(index));
	}
	...
	[DataRow(TestString02, 0, 3)] // "Hey"
	[DataRow(TestString02, 1, 4)] // "This"
	[DataRow(TestString02, 2, 2)] // "Is"
	[DataRow(TestString02, 3, 7)] // "A Test "
	[DataRow(TestString02, 4, 7)] // " Method"
	[DataRow(TestString02, 5, 0)] // ""
	[DataRow(TestString02, 6, 1)] // "."
	...
	[DataRow(TestString02, 0, "Hey")]      // H in "Hey"
	[DataRow(TestString02, 3, "Hey")]      // CR in "Hey\r\n"
	[DataRow(TestString02, 4, "Hey")]      // LF in "Hey\r\n"
	[DataRow(TestString02, 5, "This")]     // T in "This"
	[DataRow(TestString02, 13, "A Test ")] // A in "A Test"
	[DataRow(TestString02, 15, "A Test ")] // T in "Test"
	[DataRow(TestString02, 22, " Method")] // M in "Method"
	[DataRow(TestString02, 28, " Method")] // First CR in "\r\n\r\n."
	[DataRow(TestString02, 29, " Method")] // First LF in "\r\n\r\n."
	[DataRow(TestString02, 30, "")]        // Second CR in "\r\n\r\n."
	[DataRow(TestString02, 31, "")]        // Second LF in "\r\n\r\n."
	[DataRow(TestString02, 32, ".")]       // Dot/point in Second LF in "\r\n\r\n."
	[DataRow(TestString02, 33, "")]        // End of file
