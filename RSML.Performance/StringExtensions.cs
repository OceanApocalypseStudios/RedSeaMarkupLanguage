...
namespace OceanApocalypseStudios.RSML.Performance
{
	...
	internal static class StringExtensions
	{
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		internal static bool IsEquals(this ReadOnlySpan<char> chars, string? str) => str is not null && chars.SequenceEqual(str);
