...
namespace OceanApocalypseStudios.RSML.Native.Structures
{
	...
	public static class SyntaxExtensions
	{
		...
		public static NativeToken ToNativeToken(this SyntaxToken token) => new()
		{
			...
			startIndex = token.BufferRange.Start.IsFromEnd ? -token.BufferRange.Start.Value : token.BufferRange.Start.Value,
			endIndex = token.BufferRange.End.IsFromEnd ? -token.BufferRange.End.Value : token.BufferRange.End.Value
