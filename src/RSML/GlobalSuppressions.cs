...
[assembly: SuppressMessage("Style", "IDE0045:Convert to conditional expression", Justification = "<Pending>", Scope = "member", Target = "~M:OceanApocalypseStudios.RSML.Analyzer.Syntax.SyntaxLine.AddToEnd(OceanApocalypseStudios.RSML.Analyzer.Syntax.SyntaxToken)")]
[assembly: SuppressMessage("Style", "IDE0045:Convert to conditional expression", Justification = "<Pending>", Scope = "member", Target = "~M:OceanApocalypseStudios.RSML.Analyzer.Syntax.SyntaxLine.Add(OceanApocalypseStudios.RSML.Analyzer.Syntax.SyntaxToken)")]
