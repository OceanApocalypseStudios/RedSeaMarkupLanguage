...
namespace OceanApocalypseStudios.RSML.Buffers
{
	...
	/// <summary>
	/// Represents a buffer that supports async functionality.
	/// </summary>
	/// <typeparam name="TItem">The datatype of the values returned by the buffer methods</typeparam>
	public partial interface IAsyncBuffer<TItem>
	{
		...
		Task<bool> TryReadAsync(out TItem item);
		...
		Task<bool> TryReadLineAsync(ReadOnlySpan<TItem> line, out int consumed);
		...
		/// <param name="consumed">The amount of items that were consumed.</param>
		/// <returns>False if the buffer was fully consumed, there are no more lines to read or an exception occured.</returns>
		Task<bool> TryReadLineAsync(int index, ReadOnlySpan<TItem> line, out int consumed);
		...
		/// </remarks>
		/// <returns>False if the buffer was fully consumed or an exception occured.</returns>
		Task<bool> TryReadWordAsync(ReadOnlySpan<TItem> destination, out bool isWhitespace, out int consumed);
		...
		/// </remarks>
		/// <returns>False if the buffer was fully consumed or an exception occured.</returns>
		Task<bool> TryReadWordAsync(int index, ReadOnlySpan<TItem> destination, out bool isWhitespace, out int consumed);
		...
		/// </remarks>
		/// <returns>False if the buffer was fully consumed or an exception occured.</returns>
		Task<bool> TryReadWordAsync(TItem itemKind, ReadOnlySpan<TItem> destination, out bool isItemKind, out int consumed);
		...
		Task<bool> TryReadWordAsync(int index, TItem itemKind, ReadOnlySpan<TItem> destination, out bool isItemKind, out int consumed);
		...
		/// <returns>False if the buffer was fully consumed or an exception occured.</returns>
		Task<bool> TryReadUntilWhitespaceAsync(ReadOnlySpan<TItem> destination, out int consumed);
		...
		/// <param name="consumed">The amount of consumed items.</param>
		/// <returns>False if the buffer was fully consumed or an exception occured.</returns>
		Task<bool> TryReadUntilWhitespaceAsync(int index, ReadOnlySpan<TItem> destination, out int consumed);
		...
		/// The amount of consumed items; <c>-1</c> if no items were consumed or an error occured.
		/// </returns>
		Task<int> SkipWhitespaceAsync(int index);
		...
		/// or an error occured.
		/// </returns>
		Task<bool> TryConsumeAsync(TItem item);
		...
		/// or an error occured.
		/// </returns>
		Task<bool> TryConsumeAsync(ReadOnlySpan<TItem> items);
